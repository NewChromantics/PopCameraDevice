...
SOY_PATH = $(LOCAL_PATH)/$(SRC)/Source/SoyLib
...
$(LOCAL_PATH)/$(SRC)/Source/MagicEnum/include \
$(SOY_PATH)/src	\
...
LOCAL_SRC_FILES  := \
$(LOCAL_PATH)/$(SRC)/Source/PopCameraDevice.cpp \
$(LOCAL_PATH)/$(SRC)/Source/TestDevice.cpp \
$(LOCAL_PATH)/$(SRC)/Source/TCameraDevice.cpp \
