...
#define POPCAMERADEVICE_KEY_WORLDGEOMETRYSTREAM		"WorldGeometryStream"	//	output world (scene reconstruction) geometry triangles as float-images in their own stream
